...
A full-stack volunteer-need matching system for NGOs. This platform connects community needs with available volunteers using intelligent matching algorithms, NLP-powered data extraction, and real-time notifications.

![React](https://img.shields.io/badge/React-18-blue) ![Node.js](https://img.shields.io/badge/Node.js-18-green) ![Python](https://img.shields.io/badge/Python-3.11-yellow) ![SQLite](https://img.shields.io/badge/SQLite-3-lightblue)
...
- **NLP Text Extraction** — Extract structured data from paper surveys using OCR + spaCy NLP
...
- **OCR Pipeline** — Upload survey images → Tesseract OCR → NLP extraction → auto-create needs
...
- **Heatmap Visualization** — Leaflet.js map with color-coded urgency markers
...
> If the NLP service is not running, the backend automatically falls back to a local regex-based extraction.
...
|--------|----------|-------------|
| POST | `/extract` | Extract fields from text |
